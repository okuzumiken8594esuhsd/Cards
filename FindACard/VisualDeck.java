...
public class VisualDeck extends Deck implements ActionListener {
	...
	/**
	 * The panel that will be displayed in the window, to be swapped out
	 * <br>
	 * This one contains the entire deck face up
	 */
	protected JPanel spreadDeck;
	...
	public void display(int x, int y) {
		...
		spreadDeck = new JPanel();
		spreadDeck.setLayout(new GridLayout(displayHeight, displayWidth));
		addTextPanes();
		table.add(spreadDeck);
				
		// menu bars are designed to 
		menuBar = makeMenuBar();
	...
	/**
	 * Adds the JTextPane from this.createTextPane(int) to the JPanel spreadDeck
	 */
