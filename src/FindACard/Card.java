...
/**
 * This class models a card in a deck, in text and image based form
...
public class Card {
	...
	/**
	 * Changes the next card variables to the next card <br>
	...
	/**
	 * Compares the cards, ignoring suit
	...
	/**
	 * equals for cards, ignoring suit <br>
	 * Examples: <br>
	 * Ace of Diamonds == Ace of Hearts <br>
	 * Three of Spades == Three of Hearts <br>
	...
	/**
	 * Returns the card as a String <hr>
	 * 1 = Ace <br>
	 * Number in between = two, three, etc. <br>
	 * 11 = Jack <br>
	 * 12 = Queen <br>
	 * 13 = King <br>
	...
	/**
	 * Returns the file path to the card
	 * @return the file name of the card, as a string
	 */
	public String toImage() {
		if (!frontSide) {
			return new String("PNG-cards/back.png");
		}
		...
		String fileString = cardNumber + "_of_" + suit;
		System.out.println("fileString " + fileString);
		
		return "PNG-cards/" + fileString;
	}
